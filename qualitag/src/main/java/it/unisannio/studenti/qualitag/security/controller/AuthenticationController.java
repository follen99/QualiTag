...
public class AuthenticationController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody UserRegistrationDto userRegistrationDto) throws Exception {
    ...
    public ResponseEntity<?> resetPassword(@RequestParam String token, @RequestBody PasswordUpdateDto passwordUpdateDto) {
