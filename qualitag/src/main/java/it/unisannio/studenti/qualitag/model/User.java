...
public class User {
    ...
    public String toString() {
        return "User{" + "userId='" + userId + '\'' + ", username='" + username + '\'' + ", email='" + email + '\'' + ", name='" + name + '\'' + ", surname='" + surname + '\'' + ", projectIds=" + projectIds + ", teamIds=" + teamIds + ", tagIds=" + tagIds + ", roles=" + projectRoles + '}';
    }
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return projectRoles.entrySet().stream().map(entry -> new SimpleGrantedAuthority(entry.getKey() + ":" + entry.getValue())).collect(Collectors.toList());
    }
