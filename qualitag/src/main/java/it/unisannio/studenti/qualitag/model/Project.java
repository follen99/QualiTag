...
public class Project {
     ...
     */
    public Project (String project_id, String project_name, Date project_deadline,  String project_description) {
     ...
     * @param project_description The project's description
     */
    public Project (String project_id, String project_name, User user ,Date project_deadline, String project_description) {
        this.project_id = project_id;
        this.project_name = project_name;
        this.users = new ArrayList<User>();
        users.add(user);
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getProject_id(), getProject_name(), getUsers(), getTeams(), getProject_deadline(), getProject_creation_date(), getProject_description());
    }
